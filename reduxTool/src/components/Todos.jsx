    ...
    <ul className="list-none">
        {todos.map((todo) => (
          ...
          >
            ...
            <button className="ml-3 bg-white text-black text-center w-20 h-8 font-bold
             border-0 py-1 px-3 focus:outline-none hover:caret-green-50 rounded text-md" 
            onClick={()=>{
            ...
            {isTodoEditable!==todo.id ? "edit" : "save" }
            </button>
          </li>
        ))}
      </ul>
